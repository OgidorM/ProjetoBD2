...
DROP TABLE IF EXISTS LUGARESSESSAO CASCADE;
...
/* Table: LUGARESSESSAO                                              */
/*==============================================================*/
CREATE TABLE LUGARESSESSAO (
    LUGARSESSAOID  INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    SESSAOID   INTEGER NOT NULL,
    LUGARID    INTEGER NOT NULL,
    ESTADO     VARCHAR(20) DEFAULT 'Livre',  -- LIVRE | OCUPADO
    FOREIGN KEY (SESSAOID) REFERENCES SESSOES(SESSAOID),
...
CREATE TABLE BILHETES (
   ...
   CONSTRAINT FK_BILHETES_PERTENCEM_LUGARES FOREIGN KEY (LUGARID)
      REFERENCES LUGARESSESSAO (LUGARSESSAOID)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
