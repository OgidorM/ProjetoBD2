...
(1,1,'Velozes e Furiosos 11','2025-05-15',140,'Universal Pictures','2028-12-31','PT','A família de Dominic Toretto enfrenta uma nova ameaça global.',3,0),
(2,1,'Super Mario Bros. O Filme','2025-04-10',92,'Nintendo/Illumination','2028-12-31','PT','Mario e Luigi embarcam numa aventura no Reino dos Cogumelos.',2,0),
(3,2,'Oppenheimer','2025-07-20',180,'Universal Pictures','2028-12-31','PT','A história do físico J. Robert Oppenheimer e a bomba atômica.',3,0),
(4,2,'Dune: Parte Dois','2025-03-01',166,'Warner Bros','2028-12-31','PT','Paul Atreides une-se aos Fremen numa guerra pela especiaria.',3,0),
(5,3,'Scream VI','2025-06-09',123,'Paramount Pictures','2028-12-31','PT','Ghostface regressa para aterrorizar uma nova geração.',4,0),
(6,3,'Titanic Re-Release','2025-02-14',195,'Paramount Pictures','2028-12-31','PT','O épico romance entre Jack e Rose no navio condenado.',3,0),
(7,4,'Indiana Jones 5','2025-06-30',154,'Lucasfilm','2028-12-31','PT','A última aventura do arqueólogo mais famoso do cinema.',3,0),
(8,4,'Toy Story 5','2025-06-16',100,'Pixar','2028-12-31','PT','Woody, Buzz e os brinquedos voltam numa nova aventura.',2,0);
...
(3, 4, '2026-01-08 20:00:00', '2026-03-08 22:46:00', 'PT', 'Ativa', 11.00), -- Dune 2
(4, 5, '2026-03-22 22:00:00', '2026-03-23 00:03:00', 'PT', 'Ativa', 9.00),  -- Scream
(5, 6, '2026-03-12 19:00:00', '2026-03-12 22:15:00', 'EN', 'Ativa', 12.00), -- Titanic
(6, 7, '2026-02-02 21:00:00', '2026-04-28 23:34:00', 'PT', 'Ativa', 9.50),  -- Indiana
(1, 8, '2026-01-24 16:00:00', '2026-03-10 17:40:00', 'PT', 'Ativa', 8.00);  -- Toy Story

INSERT INTO sessoes (salaid, filmeid, inicio, fim, versao, estadosessao, precosessao) VALUES
(1, 2, '2027-12-10 18:00:00', '2027-12-10 19:32:00', 'PT', 'Ativa', 7.50), -- Super Mario (Futuro Fake)
(2, 3, '2027-12-25 21:00:00', '2027-12-25 23:55:00', 'EN', 'Ativa', 10.50); -- Oppenheimer (Futuro Fake)

-- Vendas Históricas (Setembro 2025)
...
(1,6,9.50,'2025-09-23 12:30:00'), 
(2,7,10.50,'2025-09-23 14:00:00'),
(3,2,8.00,'2025-09-26 16:00:00');
...
-- CORREÇÃO HISTÓRICA: Mover sessões 6 e 7 para o passado (2025)
-- O trigger trg_impedir_bilhete só dispara no INSERT do bilhete, não no UPDATE da sessão.
UPDATE sessoes SET inicio = '2025-12-10 18:00:00', fim = '2025-12-10 19:32:00', estadosessao = 'Concluída' WHERE sessaoid = 6;
UPDATE sessoes SET inicio = '2025-12-25 21:00:00', fim = '2025-12-25 23:55:00', estadosessao = 'Concluída' WHERE sessaoid = 7;
