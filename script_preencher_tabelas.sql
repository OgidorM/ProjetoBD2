...
-- 4. Insert Salas (Cinema Rooms)
INSERT INTO salas (cinemaid, nomesala, capacidade, tiposala) VALUES
(1, 'Sala 1', 200, 'Standard'),
(1, 'Sala 2', 150, 'VIP'),
(1, 'Sala 3', 180, 'IMAX'),
(2, 'Sala A', 250, 'Standard'),
(2, 'Sala B', 120, 'VIP'),
(2, 'Sala C', 300, 'IMAX'),
(3, 'Sala Premium', 100, 'VIP'),
(3, 'Sala Grande', 280, 'Standard'),
(4, 'Sala Central', 160, 'Standard'),
(4, 'Sala Digital', 140, 'Standard');

-- 5. Insert Filmes (Movies)
...
-- 7. Insert Funcionarios (Employees)
...
-- 8. Insert Produtos (Concession Products)
...
('M&Ms', 3.00, 90, true),
('Combo Casal', 15.00, 50, true),
('Hot Dog', 5.50, 40, true),
('Ice Tea', 3.50, 70, true);

-- 9. Insert Lugares (Seats)
-- Sala 1 (Cinema 1) - 200 seats
INSERT INTO lugares (salaid, fila, numero, tipolugar, estadolugar) VALUES
-- Fila A (1-20)
(1, 'A', 1, 'Standard', 'Disponível'), (1, 'A', 2, 'Standard', 'Disponível'), (1, 'A', 3, 'Standard', 'Disponível'), (1, 'A', 4, 'Standard', 'Disponível'), (1, 'A', 5, 'Standard', 'Disponível'),
(1, 'A', 6, 'Standard', 'Disponível'), (1, 'A', 7, 'Standard', 'Disponível'), (1, 'A', 8, 'Standard', 'Disponível'), (1, 'A', 9, 'Standard', 'Disponível'), (1, 'A', 10, 'Standard', 'Disponível'),
(1, 'A', 11, 'Standard', 'Disponível'), (1, 'A', 12, 'Standard', 'Disponível'), (1, 'A', 13, 'Standard', 'Disponível'), (1, 'A', 14, 'Standard', 'Disponível'), (1, 'A', 15, 'Standard', 'Disponível'),
(1, 'A', 16, 'Standard', 'Disponível'), (1, 'A', 17, 'Standard', 'Disponível'), (1, 'A', 18, 'Standard', 'Disponível'), (1, 'A', 19, 'Standard', 'Disponível'), (1, 'A', 20, 'Standard', 'Disponível'),
-- Fila B (1-20)
(1, 'B', 1, 'Standard', 'Disponível'), (1, 'B', 2, 'Standard', 'Disponível'), (1, 'B', 3, 'Standard', 'Disponível'), (1, 'B', 4, 'Standard', 'Disponível'), (1, 'B', 5, 'Standard', 'Disponível'),
(1, 'B', 6, 'Standard', 'Disponível'), (1, 'B', 7, 'Standard', 'Disponível'), (1, 'B', 8, 'Standard', 'Disponível'), (1, 'B', 9, 'Standard', 'Disponível'), (1, 'B', 10, 'Standard', 'Disponível'),
(1, 'B', 11, 'Standard', 'Disponível'), (1, 'B', 12, 'Standard', 'Disponível'), (1, 'B', 13, 'Standard', 'Disponível'), (1, 'B', 14, 'Standard', 'Disponível'), (1, 'B', 15, 'Standard', 'Disponível'),
(1, 'B', 16, 'Standard', 'Disponível'), (1, 'B', 17, 'Standard', 'Disponível'), (1, 'B', 18, 'Standard', 'Disponível'), (1, 'B', 19, 'Standard', 'Disponível'), (1, 'B', 20, 'Standard', 'Disponível');

-- Sample seats for Sala 2 (VIP - 150 seats)
INSERT INTO lugares (salaid, fila, numero, tipolugar, estadolugar) VALUES
(2, 'A', 1, 'VIP', 'Disponível'), (2, 'A', 2, 'VIP', 'Disponível'), (2, 'A', 3, 'VIP', 'Disponível'), (2, 'A', 4, 'VIP', 'Disponível'), (2, 'A', 5, 'VIP', 'Disponível'),
(2, 'A', 6, 'VIP', 'Disponível'), (2, 'A', 7, 'VIP', 'Disponível'), (2, 'A', 8, 'VIP', 'Disponível'), (2, 'A', 9, 'VIP', 'Disponível'), (2, 'A', 10, 'VIP', 'Disponível'),
(2, 'B', 1, 'VIP', 'Disponível'), (2, 'B', 2, 'VIP', 'Disponível'), (2, 'B', 3, 'VIP', 'Disponível'), (2, 'B', 4, 'VIP', 'Disponível'), (2, 'B', 5, 'VIP', 'Disponível'),
(2, 'B', 6, 'VIP', 'Disponível'), (2, 'B', 7, 'VIP', 'Disponível'), (2, 'B', 8, 'VIP', 'Disponível'), (2, 'B', 9, 'VIP', 'Disponível'), (2, 'B', 10, 'VIP', 'Disponível');

-- 9. Insert Sessoes (Movie Sessions)
INSERT INTO sessoes (salaid, filmeid, inicio, fim, versao, estadosessao, precosessao) VALUES
(1, 2, '2025-10-10 18:00:00', '2025-10-10 19:32:00', 'PT', 'Ativa', 7.50),
(2, 3, '2025-10-25 21:00:00', '2025-10-25 23:55:00', 'EN', 'Ativa', 10.50),
...
(2, 1, '2026-01-25 20:00:00', '2026-01-25 22:20:00', 'EN', 'Ativa', 9.50),
(3, 2, '2026-02-08 18:00:00', '2026-02-08 19:32:00', 'PT', 'Ativa', 7.50),
(4, 3, '2026-02-22 21:00:00', '2026-02-22 23:55:00', 'EN', 'Ativa', 10.50),
(5, 4, '2026-03-14 19:30:00', '2026-03-14 22:16:00', 'PT', 'Ativa', 11.00),
(6, 5, '2026-03-28 21:00:00', '2026-03-28 23:03:00', 'PT', 'Ativa', 9.00);


-- 10. Insert Vendas (corrigido)
...
(4, 4, '2025-09-23', 'Pendente', 12.00),
(5, 1, '2025-09-23', 'Concluída', 22.50);

-- 11. Insert Vendalinhas
INSERT INTO vendalinhas (vendaid, produtoid, quantidade, total_linha_, precolinha) VALUES
(1, 1, 1, 6.50, 6.50),  -- Pipocas Grandes
(1, 4, 1, 4.00, 4.00),  -- Coca-Cola
(2, 2, 1, 5.00, 5.00),  -- Pipocas Médias
(2, 5, 1, 2.50, 2.50),  -- Água
(3, 8, 2, 30.00, 15.00), -- 2x Combo Casal
(4, 3, 1, 3.50, 3.50),  -- Pipocas Pequenas
(5, 6, 1, 7.00, 7.00),  -- Nachos
(5, 7, 2, 6.00, 3.00);  -- 2x M&Ms
...
(1, 1, 9.50, '2025-09-23 12:30:00'),  -- sessão 1
(1, 2, 9.50, '2025-09-23 12:30:00'),  -- sessão 2
(2, 3, 8.50, '2025-09-23 13:45:00'),  -- sessão 3
(3, 4, 10.00, '2025-09-23 14:20:00'), -- sessão 4
(3, 5, 10.00, '2025-09-23 14:20:00'), -- sessão 5
(4, 6, 8.50, '2025-09-23 15:10:00'),  -- sessão 6
(5, 7, 9.50, '2025-09-23 16:00:00');  -- sessão 7

-- 13. Insert Avaliacoes
...
(4, 'Funcionário Muito Atencioso', 4, 4, 5, 'A equipe foi muito prestativa.'),
(5, 'Experiência Negativa', 2, 2, 2, 'Poltronas desconfortáveis e filme atrasou.');

-- Atualizar ranking de CINEMAS (média das avaliações de cinema)
UPDATE cinemas c
SET ranking = (
    SELECT ROUND(AVG(avaliacaocinema)::numeric,1)
    FROM avaliacoes a
...
-- Atualizar ranking de FUNCIONARIOS (média das avaliações de funcionário)
UPDATE funcionarios f
SET ranking = (
    SELECT ROUND(AVG(avaliacaofuncionario)::numeric,1)
    FROM avaliacoes a
    JOIN vendas v ON a.vendaid = v.vendaid
...
-- Atualizar ranking de FILMES (média das avaliações de filme)
UPDATE filmes fi
SET ranking = (
    SELECT ROUND(AVG(avaliacaofilme)::numeric,1)
    FROM avaliacoes a
    JOIN vendas v ON a.vendaid = v.vendaid
    WHERE a.avaliacaofilme IS NOT NULL
)
WHERE EXISTS (
    SELECT 1
    FROM avaliacoes a
